...
public class DynFields {
  ...
  public static class UnboundField<T> {
    ...
    public BoundField<T> bind(Object target) {
      ...
      if (!field.getDeclaringClass().isAssignableFrom(target.getClass())) {
        throw new IllegalArgumentException(
            "Cannot bind field " + name + " to instance of " + target.getClass());
      }
    ...
    public StaticField<T> asStatic() {
      if (!isStatic()) {
        throw new IllegalStateException("Field " + name + " is not static");
      }
    ...
    public <T> UnboundField<T> buildChecked() throws NoSuchFieldException {
      if (field != null) {
        ...
        throw new NoSuchFieldException(
            "Cannot find field from candidates: " + String.join(", ", candidates));
      }
    }
